...
function openVideoModal(e) {
  ...
  if (player && videoUrl) {
    if (videoUrl.includes('youtube.com') || videoUrl.includes('youtu.be')) {
      ...
      if (ytId) player.innerHTML = `<iframe width="100%" height="100%" src="https://www.youtube.com/embed/${ytId}?autoplay=1" frameborder="0" allowfullscreen style="border-radius:8px;"></iframe>`;
    } else {
...
function closeVideoModal(e) {
  ...
  if (player) {
    ...
    if (iframe) iframe.src = iframe.src; // pause youtube
